...
set_keymap('n', '<leader>u', ':Telescope file_browser theme=ivy <CR>')
set_keymap('n', '<C-f>', ':Telescope live_grep theme=dropdown<CR>')
set_keymap('n', '<C-p>', ':Telescope find_files theme=dropdown<CR>')
